																...
																<div class="row">
																	<div class="col-md-10">
																		<div class="focused">
																			...
																			<input type="text" class="form-control form-control-alternative" style="background-color: white;" readonly value="${deliverVo.dlvr_name }">
																		</div>
																	</div>
																	<div class="col-md-2">
																...
																<div class="row">
																	<div class="col-md-10">
																		...
																		<div class="divOrgPw">
																			...
																			<input type="password"  class="form-control form-control-alternative" style="background-color: white;" readonly value="${deliverVo.dlvr_pw }">
																		</div>
																			<div class="divChgPw">
																				<form class="frmChgPw" action="/deliver/pwChange" method="post">
																	...
																	<div class="col-md-10">
																		<div class="focused">
																			...
																			<div class="divOrgEmail">
																				<input type="email" class="form-control form-control-alternative" style="background-color: white;" readonly value="${deliverVo.dlvr_email }">
																			</div>
																			
																			<div class="divChgEmail">
																				<form class="frmChgEmail" action="/deliver/emailChange" method="POST">
																		...
																		<div class="focused">
																			...
																			<label class="form-control-label">휴대폰</label> 
																				<div class="divOrgPhone">
																					<input type="tel" class="form-control form-control-alternative" style="background-color: white;" readonly value="${deliverVo.dlvr_phone }">
																				</div>
																				<div class="divChgPhone">
																					<form class="frmChgPhone" action="/deliver/phoneChange" method="POST">
																	...
																	<div class="col-md-10">
																		<div class="focused">
																			...
																			<div class="divOrgAddr">
																				<input type="text" class="form-control form-control-alternative" style="background-color: white;" readonly value="${sessionScope.deliverVo.dlvr_addr}">
																			</div>	
																			<div class="divChgAddr">
																				<form role="form" class="frmChgAddr" action="/deliver/addrChange" method="POST" >
															...
															<div class="row">
																<div class="col-md-10">
																	...
																	<img id="chgImgPreview" src="#" alt="변경한 프로필 사진" style="width: 200px; height: 200px; display: none;"/>
																		<form role="form" class="frmChgImg" action="/deliver/imgChange" method="POST" enctype="multipart/form-data">
...
<script src="/resources/js/deliverInfoScript.js"></script>
</html>