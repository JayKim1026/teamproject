...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-6">
				<div class="senderForm" style="display: none;">
					<span></span> <span></span> <span></span> <img alt="senderImg"
						src="" class="profile-pic">
					<hr />
				</div>

				<div class="receiverForm" style="display: none;">
					<img alt="receiverImg" src="" class="profile-pic"> <span></span>
					<span></span> <span></span>
					<hr />
				</div>

				<div class="senderImgForm" style="display: none;">
					<span></span> <img alt="msgImg" src="" class="message_image">
					<span></span> <img alt="senderImg" src="" class="profile-pic">
					<hr />
				</div>

				<div class="receiverImgForm" style="display: none">
					<img alt="receiverImg" src="" class="profile-pic"> <span></span>
					<img alt="msgImg" src="" class="message_image"> <span></span>
					<hr />
				</div>
			</div>
			<div class="col-md-3"></div>
		...
		<section style="margin-top: 200px">
			<div class="row">
				<div class="col-md-3"></div>
				<div class="col-md-6" id="chatForm"
					style="overflow: auto; width: auto; height: 500px; background-color: whitesmoke;"></div>
				<div class="col-md-3"></div>
			</div>
		</section>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="message_write_section">
						...
						<input type="file" class="btn btn-dark" id="msgImg"
