																...
																<div class="row">
																	<div class="col-md-10">
																		...
																		<div class="divOrgPw">
																			...
																			<input type="text"  class="form-control form-control-alternative" style="background-color: white;" readonly value="${userVo.user_pw }">
																		</div>
																			<div class="divChgPw">
																				<form class="frmChgPw" action="/user/pwChange" method="post">
																					<label class="form-control-label" for="input-password"> 현재 비밀번호</label>
																					<input type="text" id="orgPw" name="orgPw" class="form-control form-control-alternative">
																					
																					<label class="form-control-label" for="input-password">새 비밀번호</label>
																					<input type="text" id="chgPw" name="chgPw" class="form-control form-control-alternative">
																					
																					<label class="form-control-label" for="input-password">새 비밀번호 확인</label>
																					<input type="text" id="chgPw2" name="chgPw2" class="form-control form-control-alternative">
																					<div style="display: flex;">
