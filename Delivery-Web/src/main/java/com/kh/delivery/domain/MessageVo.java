...
public class MessageVo {
	...
	public String toString() {
		return "MessageVo [msg_no=" + msg_no + ", order_no=" + order_no + ", sender_no=" + sender_no + ", receiver_no="
				+ receiver_no + ", msg_content=" + msg_content + ", msg_img=" + msg_img + ", msg_date=" + msg_date
				+ ", sender_name=" + sender_name + ", sender_img=" + sender_img + "]";
	}
